    ...
    return (
        ...
        <div className='col-md-6 text-center mx-auto border border-secondary p-4  bg-light rounded'>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <br/>
                <input onBlur={handleBlur} className='border border-secondary w-75 mb-2  rounded p-2' placeholder='Email' type="email" name='email'/>
                <br/>
                <input onBlur={handleBlur} className='border border-secondary w-75 mb-2  rounded p-2' placeholder='Password' type="password" name='password'/>
                <br/>
                ...
                <p style={{color:'red'}}>{user.error}</p>
              {
                  ...
                  {newUser ? 'Created' : 'Logged In'} { newUser ?'Account' : ''} Successfully </p>
