        ...
        <div className="header">
            ...
            <div className='col-md-6 text-center mx-auto border border-secondary p-4  bg-light rounded'>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <br />
                    <input onBlur={handleBlur} className='border border-secondary w-75 mb-2  rounded p-2' placeholder='Password @example qwer12' type="password" required name='password' />
                    <br />
